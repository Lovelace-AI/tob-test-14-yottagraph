...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `import { useElementalClient } from '@yottagraph-app/elemental-api/client'` | `import { useElementalClient } from '@yottagraph-app/elemental-api/client'` |
...
export default defineFeatureModule({
    ...
    requires: ['useElementalClient'], // List actual dependencies
});
```
...
1. Verify Aether composables (`useModuleRegistry`, etc.) are imported from `#imports` and `useElementalClient` from `@yottagraph-app/elemental-api/client`
